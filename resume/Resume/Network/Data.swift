...
let experienceList: [Experience] = [
    ...
    Experience(position: "Co-founder, President, iOS Developer",
               ...
               emphasisList: [
                ...
                Emphasis(title: "Launched proof-of-concept iOS app. Contributed to the UX/UI design and more than 50% of the iOS app. As of Jan 2, 2022, the app is still available on the App Store (apps.apple.com/us/app/apagon-app/id1362697139)",
